...
public class ExcelService {
    ...
    private void outputPatientInfoExcel(List<PatientInfo> patientInfoList, String directory, String nowDateStr) {
        ...
        for (int i = 0; i < patientInfoList.size(); i++) {
            ...
            col[18] = patientInfo.getOtherMedicalHistory();
            col[19] = patientInfo.getSmokingHistory();
            col[20] = String.valueOf(patientInfo.getSmokingNumEachDay());
            col[21] = String.valueOf(patientInfo.getSmokingYears());
            col[22] = patientInfo.getDrinkingHistory();
            col[23] = patientInfo.getDrinkingType();
            col[24] = patientInfo.getDrinkingNumEachDay();
            col[25] = String.valueOf(patientInfo.getDrinkingYears());
            col[26] = patientInfo.getIsMentalDiseaseFamilyHistory();
            col[27] = patientInfo.getMentalDiseaseFamilyHistory();
            col[28] = patientInfo.getOtherMentalDiseaseFamilyHistory();
            col[29] = patientInfo.getCurrentMedicalHistoryMemoryLoss();
            col[30] = patientInfo.getMemoryLossTime();
            col[31] = patientInfo.getPhysicalExamination();
            col[32] = patientInfo.getIsUseCognitiveDrugs();
